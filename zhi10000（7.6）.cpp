...
int main()
{
	...
	while(1)
	{
		...
		if(s==-1)
		{
			cout<<"zhi10000系统是支持中文、英文（6.0之后）的质数演算系统，自2020年7月起研发，至今共有2.0，2.5，3.0，3.5，4.0，4.2，4.5，5.0，6.0，7.0，7.2，7.5，7.6十三个版本问世。";
			...
			else
			{
				if(s==-3)
				{
					...
					while(1)
					{
						...
						if(s==-1)
						{
							cout<<"Zhi10000 system is a prime number calculus system that supports Chinese and English (after 6.0). It has been developed since July 2020. So far, thirteen versions of 2.0, 2.5, 3.0, 3.5, 4.0, 4.2, 4.5, 5.0, 6.0, 7.0, 7.2, 7.5 and 7.6 have been published.";
